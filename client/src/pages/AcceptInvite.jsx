...
import { Bot, User, Lock, ArrowRight, CheckCircle2, XCircle } from 'lucide-react';
            ...
            <div className="animate-fade-in-up space-y-6">
              <div className="flex flex-col items-center text-center gap-3 py-4">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Your account is ready. Sign in with your new password to get started.
                </p>
              </div>
              ...
              {error ? (
                <div className="animate-fade-in-up space-y-6">
                  <div className="flex flex-col items-center text-center gap-3 py-4">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Invite invalid</h2>
                ...
                <>
                  ...
                  <div className="space-y-2 animate-fade-in-up" style={{ animationDelay: '80ms', animationFillMode: 'both' }}>
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Accept invitation</h2>
                    <p className="text-gray-500 dark:text-gray-400">Set your name and password to activate your account.</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="animate-fade-in-up" style={{ animationDelay: '320ms', animationFillMode: 'both' }}>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-600 via-primary-700 to-violet-800 p-12 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-white max-w-xl space-y-8">
          ...
          <div className="space-y-4 animate-fade-in-up" style={{ animationDelay: '300ms', animationFillMode: 'both' }}>
            <h2 className="text-4xl font-bold leading-tight">Welcome to SupportAI</h2>
            <p className="text-xl text-primary-100">Set up your account and start collaborating with your team.</p>
          </div>

          <div className="space-y-3">
            {[
              { icon: '🤝', text: 'Collaborate with your team in real time' },
              { icon: '🎫', text: 'Manage tickets and customer conversations' },
              { icon: '📊', text: 'Access analytics and insights' },
            ].map((feat, i) => (
